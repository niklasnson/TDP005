...
komradkommand:  game_object.o main_game.o game_state.o start.o game.o endgame.o level.o rotatable.o player.o main.o missile.o friendly_missile.o house.o static.o marker.o enemy_missile.o sprite.o explosion.o powerup.o text.o super_friendly_missile.o variables.o
